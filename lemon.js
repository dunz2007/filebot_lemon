...
const { Sequelize, sequelize } = require("./Lemonee/database");
...
function onBot({ models: botModel }) {
    ...
    login(loginData, async(loginError, loginApiData) => {
        ...
        const listener = require('./Lemonee/listen')(listenerData);
    ...
    try {
        try {
            ...
            const sequelize2 = new Sequelize({
                dialect: "sqlite",
                host: __dirname + '/Fcasex/datasqlite/antists.sqlite',
                logging: false
            });
        ...
        authentication.sequelize = sequelize;
        const models = require('./Lemonee/database/model')(authentication);
        const botData = {};
