...
module.exports.run = async ({ api, event, args }) => {
  if (args[0] === "on") {
    isvideoanimeEnabled = true;
    api.sendMessage("Tự động gửi video anime đã được bật.", event.threadID, event.messageID);
  } else if (args[0] === "off") {
    isvideoanimeEnabled = false;
    api.sendMessage("Tự động gửi video anime đã được tắt.", event.threadID, event.messageID);
  } else {
