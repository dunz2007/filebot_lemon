...
module.exports.handleReply = async function ({ api, event, handleReply }) {
  ...
  const fs = require("fs");
    ...
    switch (reply_type) {
      ...
      api.sendMessage({body: '====『 𝗬𝗢𝗨𝗧𝗨𝗕𝗘 』====\n📝 𝗩𝘂𝗶 𝗹𝗼̀𝗻𝗴 𝗽𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗼̛́𝗶 𝗰𝗮́𝗰 𝗹𝘂̛̣𝗮 𝗰𝗵𝗼̣𝗻 𝗱𝘂̛𝗼̛́𝗶 đ𝗮̂𝘆:\n\n『➊』 𝗧𝗮̉𝗶 𝘃𝗶𝗱𝗲𝗼\n『➋』 𝗧𝗮̉𝗶 𝗮̂𝗺 𝘁𝗵𝗮𝗻𝗵', attachment: fs.createReadStream(__dirname + `/noprefix/ytb.jpeg`)}, event.threadID, 
          (error, info) => {
                            if (error) {
                                console.log(error);
...
module.exports.run = async function ({ api, event, args }) {
    ...
    try {
        if (isValidUrl) {
            ...
            api.sendMessage('====『 𝗬𝗢𝗨𝗧𝗨𝗕𝗘 』====\n📝 𝗩𝘂𝗶 𝗹𝗼̀𝗻𝗴 𝗽𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗼̛́𝗶 𝗰𝗮́𝗰 𝗹𝘂̛̣𝗮 𝗰𝗵𝗼̣𝗻 𝗱𝘂̛𝗼̛́𝗶 đ𝗮̂𝘆:\n\n『➊』𝗧𝗮̉𝗶 𝘃𝗶𝗱𝗲𝗼\n『➋』 𝗧𝗮̉𝗶 𝗮̂𝗺 𝘁𝗵𝗮𝗻𝗵', threadID, (error, info) => {
                    if (error) {
                        console.log(error);
                    } else {
                        global.client.handleReply.push({
