...
module.exports.config = {
    ...
    version: "1.0.0",
    hasPermssion: 1,
    credits: "fix by Lemon",
    description: "Tag để chửi đứa mà bạn ghét (lưu ý sau khi dùng xong lệnh này rất có thể acc bạn sẽ bị mõm, nếu bạn hên thì acc còn, còn nếu bạn đen thì pay acc :>)",
    commandCategory: "War",
    ...
    module.exports.run = async function({ api, args, Users, event }) {
        ...
        if (!mention) return api.sendMessage("Cần phải tag 1 người bạn muốn chửi chết con mẹ nó", event.threadID);
