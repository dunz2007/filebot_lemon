...
module.exports.run = async ({ api, event, args }) => {
  if (args[0] === "on") {
    ...
    api.sendMessage("Tự động gửi video cosplay đã được bật.", event.threadID, event.messageID);
  } else if (args[0] === "off") {
    isVideocosplayEnabled = false;
    api.sendMessage("Tự động gửi video cosplay đã được tắt.", event.threadID, event.messageID);
  } else {
