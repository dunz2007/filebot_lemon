...
if (!fs.existsSync(process.cwd() + '/Fcasex') || !fs.existsSync(process.cwd() + '/Fcasex/RandPass.json')) {
  ...
  if (!fs.existsSync(process.cwd() + '/Fcasex')) {
    fs.mkdirSync(process.cwd() + '/Fcasex');
  }
  fs.writeFileSync(process.cwd() + '/Fcasex/RandPass.json', JSON.stringify(ArrPassWord, null, 2), 'utf8');
}

else {
  ArrPassWord = JSON.stringify(fs.readFileSync(process.cwd() + '/Fcasex/RandPass.json'));
}
