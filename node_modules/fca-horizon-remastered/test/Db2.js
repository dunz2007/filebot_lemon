...
if (!fs.existsSync(process.cwd() + '/Fcasex')) {
    ...
    fs.writeFileSync(process.cwd() + '/Fcasex/A_README.md', 'This folder is used by ChernobyL(NANI =)) ) to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var Database = new sqlite3.Database(process.cwd() + "/Fcasex/SyntheticDatabase.sqlite");
